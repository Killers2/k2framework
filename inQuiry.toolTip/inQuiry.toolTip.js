 ...
 * @Dependencies: inQuiry.js, inQuiry.animation.js
 */
(function ($$) {
	"use strict";
    ...
    class uiToolTip {
        constructor(options) {
            ...
            var c = new $$.cookie.create('uitooltip', null);
            ...
            this.show = () => {
                ...
                this.ttElement.fadeIn({alfa: this.alpha, delay: this.delay});
            ...
            this.hide = () => {
                ...
                this.ttElement.fadeOut(this.hideDelay, (evt) => {
            ...
            this.save = () => {
                ...
                c = new $$.cookie.create('uitooltip', 365);

                c.keys.add(new $$.cookie.item('enabled', (this.enabled ? 'true' : 'false')));
    ...
    $$.fn.uiToolTipEnable = function () {
        ...
        this.each(function(idx, inQuiryItem){
            ...
            if(inQuiryItem[0].uiToolTip)
            {
                ...
                inQuiryItem[0].uiToolTip.enable();
    ...
    $$.fn.uiToolTipDisable = function () {
        ...
        this.each(function(idx, inQuiryItem){
            ...
            if(inQuiryItem[0].uiToolTip)
            {
                ...
                inQuiryItem[0].uiToolTip.disable();
